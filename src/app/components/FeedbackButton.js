                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl p-8 max-w-lg w-full shadow-2xl border border-gray-100 relative overflow-hidden">
                        ...
                        <div className="flex justify-between items-center mb-8">
                            <div>
                                <h2 className="text-2xl font-bold text-[#111718] mb-1">We're Here to Help!</h2>
                                <p className="text-[#495057] text-sm">Share your feedback or get assistance</p>
                            </div>
                            <button
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            <div>
                                <label htmlFor="name" className="block text-sm font-bold text-[#111718] mb-3">
                                    Your Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="mobile" className="block text-sm font-bold text-[#111718] mb-3">
                                    Mobile Number
                                </label>
                                <input
                                    type="tel"
                            ...
                            <div>
                                <label htmlFor="message" className="block text-sm font-bold text-[#111718] mb-3">
                                    How can we help you?
                                </label>
                                <textarea
                                    id="message"
