            ...
            <footer className="bg-gray-50 py-12 px-6 sm:px-10">
              <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col gap-4">
                  <h4 className="font-bold text-[#111718]">Company</h4>
                  <Link
                    href="/about"
                    className="text-sm text-[#60838a] hover:text-[#0dccf2]"
                  >
                    About
                  </Link>
                  <Link
                ...
                <div className="flex flex-col gap-4">
                  <h4 className="font-bold text-[#111718]">Legal</h4>
                  <Link
                    href="/terms"
                    className="text-sm text-[#60838a] hover:text-[#0dccf2]"
                  >
                ...
                <div className="flex flex-col gap-4">
                  <h4 className="font-bold text-[#111718]">Follow Us</h4>
                  <div className="flex gap-4">
                    <a
                      href="#"
                      className="text-[#60838a] hover:text-[#0dccf2] transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
